...
@property (strong) T _Nullable result __attribute__((swift_name("result")));
@end
...
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (strong) T _Nullable first __attribute__((swift_name("first")));
@property (strong) T _Nullable second __attribute__((swift_name("second")));
@property (strong) T _Nullable third __attribute__((swift_name("third")));
@end
...
@property (class, strong) KtKotlinArray<NSString *> *delegatedGlobalArray __attribute__((swift_name("delegatedGlobalArray")));
